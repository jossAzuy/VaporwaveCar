...
namespace FronkonGames.Retro.CRTTV
{
  ...
  {
    private static readonly CRTTV[] NoEffects = new CRTTV[0];
    ...
    /// <summary> Is it in default render pipeline? </summary>
    ...
    /// <summary> Returns effect in default render pipeline or null </summary>
    ...
    /// <summary> Returns an array with all effects found. </summary>
