...
namespace FronkonGames.Weird.Edges
{
  ...
  public sealed partial class Edges
  {
    ...
    private static readonly Edges[] NoEffects = new Edges[0];
    ...
    public static Edges Instance
    {
      get
      {
        ...
        if (pipelineAsset != null)
        {
          ...
          {
            if (scriptableRendererData.rendererFeatures[i] is Edges)
              return scriptableRendererData.rendererFeatures[i] as Edges;
          }
        }
